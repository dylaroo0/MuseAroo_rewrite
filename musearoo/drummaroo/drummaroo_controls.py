...
from .drummaroo import DrumAlgorithm  # Import for algorithm_weights
...
if __name__ == "__main__":
    ...
    # print(f"Controls as dict: {controls_dict}")

    # Create from dictionary
    new_controls = DrummarooUIControls.from_dict(controls_dict)
    # print(f"Controls from dict match: {new_controls == controls}")
    ...
    # Modify a parameter
    controls.swing_amount = 0.6
    controls.rock_influence = 0.8
    controls.algorithm_weights[DrumAlgorithm.GROOVE_ARCHITECT] = 0.9

    print(f"Modified swing: {controls.swing_amount}")
    print(f"Rock influence: {controls.rock_influence}")
    print(f"Groove Architect weight: {controls.algorithm_weights[DrumAlgorithm.GROOVE_ARCHITECT]}")
